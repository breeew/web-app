...
>(({ children, className, onOpenChange, isOpen, sidebarWidth = 288, classNames = {}, sidebarPlacement = 'left', motionProps: drawerMotionProps, ...props }, ref) => {
    ...
    return (
        <>
            ...
            <div className={cn('hidden h-full max-w-[var(--sidebar-width)] overflow-x-hidden overflow-y-scroll sm:flex', className)}>{children}</div>
        </>
    );
});
